function Footer() {
  return (
    <footer className="footer bg-base-300 max-w-full items-center p-4">
      ...
      <div className="grid-flow-col justify-self-center md:justify-self-end">
        <ul className="flex gap-3">
          ...
          <li className="bg-neutral mask mask-circle p-1">
            <a href="https://www.linkedin.com/in/fm-anderson/" target="_blank">
              <svg
                className="fill-base-300 h-7 w-7"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
              >
